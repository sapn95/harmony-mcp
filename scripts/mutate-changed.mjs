...
//
// A full pass over index.js is affordable here, because the suite drives a local
// mock and not a browser. But a review round does not need the whole file
// re-proved — it needs the lines it just wrote proved, and those are exactly
